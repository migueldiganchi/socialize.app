...
(function ( $ ) {
    ...
    function create_div(id, href, title, rel, text) {
        var options = {};
        if (id) {
            options.id = 'id';
        }
...
//     console.log('not jquery: cannot load the library.');
